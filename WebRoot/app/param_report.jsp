...
<html>
  <head>
	...
	<script type="text/javascript" src="<%= basePath %>js/app/param_report.js"></script>
	<style type="text/css">
		#param_title{
			height:40px;
			font-size: 18px;
	...
	<div id="content" style="display:none;">
		...
		<div class='panel'>
			<div class='panel-item'>
				...
				<div style="display: inline-table;margin-left:80px;margin-right:10px;">历史系数</div>
				<div class='panel-item-content' style="display: inline-table;">
					<table id="param_nx_history_list" style="border-bottom: 1px solid;">
						<tr>
							<td>年度（年）</td>
							<td>1~2年</td>
							<td>3~5年</td>
			...
			<div class='panel-item'>
				...
				<div style="display: inline-table;margin-left:80px;margin-right:10px;">历史系数</div>
				<div class='panel-item-content' style="display: inline-table;">
					<table id="param_sd_history_list" style="border-bottom: 1px solid;">
						<tr>
							<td>年度（年）</td>
							<td>L≤1000米</td>
							<td>1000米＜L≤3000米</td>
